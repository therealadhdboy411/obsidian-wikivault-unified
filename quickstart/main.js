...
var PrefixTree = class {
  ...
  addFileToTree(file) {
    ...
    const fmMatchCase = (_d = metadata == null ? void 0 : metadata.frontmatter) == null ? void 0 : _d[this.settings.propertyNameToMatchCase];
    let aliasesWithMatchCase = new Set(Array.isArray(fmMatchCase) ? fmMatchCase : []);
    const fmIgnoreCase = (_e = metadata == null ? void 0 : metadata.frontmatter) == null ? void 0 : _e[this.settings.propertyNameToIgnoreCase];
    let aliasesWithIgnoreCase = new Set(Array.isArray(fmIgnoreCase) ? fmIgnoreCase : []);
