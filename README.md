...
- [x] Skip regeneration if note was manually edited
...
- [ ] Include full paragraphs, not just lines
- [ ] Capture heading hierarchy (show which section the mention is in)
...
- [x] Status bar showing current processing status
